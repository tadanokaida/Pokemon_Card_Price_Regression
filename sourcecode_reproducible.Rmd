...
Read in data stored in github to allow reproducible study
```{r, warning = FALSE, message = FALSE, include=FALSE}
# To reproduce data from date of report submission (May 7, 2024)
card_datafile <- "https://raw.githubusercontent.com/tadanokaida/Pokemon_Card_Price_Regression/master/data/card_data070524.csv"
set_datafile <- "https://raw.githubusercontent.com/tadanokaida/Pokemon_Card_Price_Regression/master/data/set_data070524.csv"
name_datafile <- "https://raw.githubusercontent.com/tadanokaida/Pokemon_Card_Price_Regression/master/data/name_data070524.csv"
card_data <- read.csv(card_datafile)
set_data <- read.csv(set_datafile)
pokemon_names <- read.csv(name_datafile)
```
